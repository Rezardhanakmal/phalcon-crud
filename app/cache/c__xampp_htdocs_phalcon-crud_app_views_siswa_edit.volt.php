   ...
   <div class="row justify-content-center"><br><br>
       <div class="col-12">
            <?php echo $this->tag->form(array('siswa/update', 'role' => 'form')); ?>
               ...
               <br>
               <input class="form-control" type="text" name="nama_lengkap" value=<?php echo $nama ?>>
               <br>
               <label for="kelas" class="my-2">Kelas</label>
               <select class="form-select form-control" aria-label="Default select example" name="isi_kelas" value=<?php echo $kelas ?>>
               ...
               <select class="form-select form-control" aria-label="Default select example" name="isi_jurusan">
